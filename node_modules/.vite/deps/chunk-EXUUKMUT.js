...
raf.setTimeout = (handler, ms) => {
  ...
  let cancel = () => {
    let i3 = timeouts.findIndex((t7) => t7.cancel == cancel);
    if (~i3)
...
function hue2rgb(p3, q, t7) {
  ...
  if (t7 < 1 / 2)
    return q;
  if (t7 < 2 / 3)
    return p3 + (q - p3) * (2 / 3 - t7) * 6;
  return p3;
}
function hslToRgb(h3, s4, l3) {
  const q = l3 < 0.5 ? l3 * (1 + s4) : l3 + s4 - l3 * s4;
  const p3 = 2 * l3 - q;
  const r4 = hue2rgb(p3, q, h3 + 1 / 3);
  const g3 = hue2rgb(p3, q, h3);
  const b4 = hue2rgb(p3, q, h3 - 1 / 3);
...
var SpringValue = class extends FrameValue {
  ...
  advance(dt) {
    ...
    anim.values.forEach((node2, i3) => {
      if (node2.done)
        return;
      const to3 = node2.constructor == AnimatedString ? 1 : payload ? payload[i3].lastPosition : toValues[i3];
      ...
      if (!finished) {
        ...
        if (!is.und(config2.duration)) {
          ...
          position = from + config2.easing(p3) * (to3 - from);
...
function useSprings(length, props, deps) {
  ...
  const values = springs.map((x5) => _extends3({}, x5));
...
function useTransition(data, props, deps) {
  ...
  useOnce(() => {
    each(usedTransitions.current, (t7) => {
      var _t$ctrl$ref;
      (_t$ctrl$ref = t7.ctrl.ref) == null ? void 0 : _t$ctrl$ref.add(t7.ctrl);
      const change = changes.get(t7);
      if (change) {
        t7.ctrl.start(change.payload);
      }
    });
    return () => {
      each(usedTransitions.current, (t7) => {
  ...
  const reused = [];
  if (prevTransitions)
    each(prevTransitions, (t7, i3) => {
      if (t7.expired) {
        clearTimeout(t7.expirationId);
        expired.push(t7);
      } else {
        i3 = reused[i3] = keys.indexOf(t7.key);
        if (~i3)
          transitions[i3] = t7;
      }
    });
  ...
  if (reused.length) {
    ...
    each(reused, (keyIndex, prevIndex) => {
      ...
      if (~keyIndex) {
        i3 = transitions.indexOf(t7);
        transitions[i3] = _extends3({}, t7, {
          item: items[keyIndex]
        });
      } else if (leave) {
        transitions.splice(++i3, 0, t7);
      }
    });
  }
  if (is.fun(sort2)) {
  ...
  each(transitions, (t7, i3) => {
    ...
    to3 = callProp(to3, t7.item, i3);
    to3 = is.obj(to3) ? inferTo(to3) : {
      to: to3
    };
    if (!to3.config) {
      const config2 = propsConfig || defaultProps.config;
      to3.config = callProp(config2, t7.item, i3, phase);
    }
    delay += trail;
    ...
    if (phase == TransitionPhase.ENTER && is.und(payload.from)) {
      ...
      payload.from = callProp(from, t7.item, i3);
    }
    const {
      onResolve
    } = payload;
    payload.onResolve = (result) => {
      ...
      if (t8.ctrl.idle) {
        ...
        if (idle && transitions2.some((t9) => t9.expired)) {
          exitingTransitions.current.delete(t8);
          if (exitBeforeEnter) {
    ...
    if (phase === TransitionPhase.LEAVE && exitBeforeEnter) {
      exitingTransitions.current.set(t7, {
        phase,
        springs,
        payload
      });
  ...
  const renderTransitions = (render) => React3.createElement(React3.Fragment, null, transitions.map((t7, i3) => {
    const {
      springs
    } = changes.get(t7) || t7.ctrl;
    const elem = render(_extends3({}, springs), t7.item, t7, i3);
  ...
  constructor(_ref) {
    ...
    eachProp(style, (value, key) => {
      if (key === "transform") {
        ...
        transforms.push(key === "rotate3d" ? ([x6, y5, z3, deg]) => [`rotate3d(${x6},${y5},${z3},${addUnit(deg, unit2)})`, isValueIdentity(deg, 0)] : (input) => [`${key}(${input.map((v4) => addUnit(v4, unit2)).join(",")})`, isValueIdentity(input, key.startsWith("scale") ? 1 : 0)]);
      }
    });
    if (inputs.length) {
...
var FluidTransform = class extends FluidValue {
  ...
  _get() {
    ...
    each(this.inputs, (input, i3) => {
      ...
      const [t7, id] = this.transforms[i3](is.arr(arg1) ? arg1 : input.map(getFluidValue));
      transform += " " + t7;
...
function rgba2(r4, g3, b4, a4) {
  if (a4 <= 0)
    r4 = g3 = b4 = NaN;
  return new Rgb(r4, g3, b4, a4);
}
...
function hslConvert(o3) {
  ...
  if (o3 instanceof Hsl)
    return o3;
  o3 = o3.rgb();
  var r4 = o3.r / 255, g3 = o3.g / 255, b4 = o3.b / 255, min3 = Math.min(r4, g3, b4), max3 = Math.max(r4, g3, b4), h3 = NaN, s4 = max3 - min3, l3 = (max3 + min3) / 2;
  if (s4) {
    if (r4 === max3)
      h3 = (g3 - b4) / s4 + (g3 < b4) * 6;
    else if (g3 === max3)
...
function labConvert(o3) {
  ...
  if (!(o3 instanceof Rgb))
    o3 = rgbConvert(o3);
  var r4 = rgb2lrgb(o3.r), g3 = rgb2lrgb(o3.g), b4 = rgb2lrgb(o3.b), y4 = xyz2lab((0.2225045 * r4 + 0.7168786 * g3 + 0.0606169 * b4) / Yn), x5, z2;
  if (r4 === g3 && g3 === b4)
    x5 = z2 = y4;
  else {
    x5 = xyz2lab((0.4360747 * r4 + 0.3850649 * g3 + 0.1430804 * b4) / Xn);
    z2 = xyz2lab((0.0139322 * r4 + 0.0971045 * g3 + 0.7141733 * b4) / Zn);
  }
  return new Lab(116 * y4 - 16, 500 * (x5 - y4), 200 * (y4 - z2), o3.opacity);
}
function lab(l3, a4, b4, opacity) {
  return arguments.length === 1 ? labConvert(l3) : new Lab(l3, a4, b4, opacity == null ? 1 : opacity);
}
function Lab(l3, a4, b4, opacity) {
  this.l = +l3;
  this.a = +a4;
...
define_default(Lab, lab, extend(Color, {
  ...
  rgb: function() {
    var y4 = (this.l + 16) / 116, x5 = isNaN(this.a) ? y4 : y4 + this.a / 500, z2 = isNaN(this.b) ? y4 : y4 - this.b / 200;
    x5 = Xn * lab2xyz(x5);
    y4 = Yn * lab2xyz(y4);
    z2 = Zn * lab2xyz(z2);
    return new Rgb(
      lrgb2rgb(3.1338561 * x5 - 1.6168667 * y4 - 0.4906146 * z2),
      lrgb2rgb(-0.9787684 * x5 + 1.9161415 * y4 + 0.033454 * z2),
      lrgb2rgb(0.0719453 * x5 - 0.2289914 * y4 + 1.4052427 * z2),
      this.opacity
    );
  }
}));
...
function hcl(h3, c8, l3, opacity) {
  return arguments.length === 1 ? hclConvert(h3) : new Hcl(h3, c8, l3, opacity == null ? 1 : opacity);
}
function Hcl(h3, c8, l3, opacity) {
  this.h = +h3;
  this.c = +c8;
...
function cubehelixConvert(o3) {
  ...
  if (!(o3 instanceof Rgb))
    o3 = rgbConvert(o3);
  var r4 = o3.r / 255, g3 = o3.g / 255, b4 = o3.b / 255, l3 = (BC_DA * b4 + ED * r4 - EB * g3) / (BC_DA + ED - EB), bl = b4 - l3, k4 = (E * (g3 - l3) - C * bl) / D, s4 = Math.sqrt(k4 * k4 + bl * bl) / (E * l3 * (1 - l3)), h3 = s4 ? Math.atan2(k4, bl) * degrees - 120 : NaN;
...
define_default(Cubehelix, cubehelix, extend(Color, {
  ...
  rgb: function() {
    var h3 = isNaN(this.h) ? 0 : (this.h + 120) * radians, l3 = +this.l, a4 = isNaN(this.s) ? 0 : this.s * l3 * (1 - l3), cosh2 = Math.cos(h3), sinh2 = Math.sin(h3);
    return new Rgb(
      255 * (l3 + a4 * (A * cosh2 + B * sinh2)),
      255 * (l3 + a4 * (C * cosh2 + D * sinh2)),
      255 * (l3 + a4 * (E * cosh2)),
      this.opacity
    );
  }
...
function basis_default(values) {
  ...
  return function(t7) {
    var i3 = t7 <= 0 ? t7 = 0 : t7 >= 1 ? (t7 = 1, n3 - 1) : Math.floor(t7 * n3), v1 = values[i3], v22 = values[i3 + 1], v0 = i3 > 0 ? values[i3 - 1] : 2 * v1 - v22, v32 = i3 < n3 - 1 ? values[i3 + 2] : 2 * v22 - v1;
    return basis((t7 - i3 / n3) * n3, v0, v1, v22, v32);
  };
}
...
function basisClosed_default(values) {
  ...
  return function(t7) {
    var i3 = Math.floor(((t7 %= 1) < 0 ? ++t7 : t7) * n3), v0 = values[(i3 + n3 - 1) % n3], v1 = values[i3 % n3], v22 = values[(i3 + 1) % n3], v32 = values[(i3 + 2) % n3];
    return basis((t7 - i3 / n3) * n3, v0, v1, v22, v32);
  };
}
...
function exponential(a4, b4, y4) {
  return a4 = Math.pow(a4, y4), b4 = Math.pow(b4, y4) - a4, y4 = 1 / y4, function(t7) {
    return Math.pow(a4 + t7 * b4, y4);
  };
}
function hue(a4, b4) {
  var d3 = b4 - a4;
  return d3 ? linear(a4, d3 > 180 || d3 < -180 ? d3 - 360 * Math.round(d3 / 360) : d3) : constant_default(isNaN(a4) ? b4 : a4);
}
function gamma(y4) {
...
function nogamma(a4, b4) {
  var d3 = b4 - a4;
  return d3 ? linear(a4, d3) : constant_default(isNaN(a4) ? b4 : a4);
}
...
var rgb_default = function rgbGamma(y4) {
  ...
  function rgb3(start2, end) {
    var r4 = color2((start2 = rgb2(start2)).r, (end = rgb2(end)).r), g3 = color2(start2.g, end.g), b4 = color2(start2.b, end.b), opacity = nogamma(start2.opacity, end.opacity);
    return function(t7) {
      start2.r = r4(t7);
      start2.g = g3(t7);
      start2.b = b4(t7);
...
function rgbSpline(spline) {
  return function(colors2) {
    var n3 = colors2.length, r4 = new Array(n3), g3 = new Array(n3), b4 = new Array(n3), i3, color2;
    for (i3 = 0; i3 < n3; ++i3) {
      color2 = rgb2(colors2[i3]);
      r4[i3] = color2.r || 0;
      g3[i3] = color2.g || 0;
      b4[i3] = color2.b || 0;
    }
...
function numberArray_default(a4, b4) {
  if (!b4)
    b4 = [];
  var n3 = a4 ? Math.min(b4.length, a4.length) : 0, c8 = b4.slice(), i3;
  return function(t7) {
    for (i3 = 0; i3 < n3; ++i3)
      c8[i3] = a4[i3] * (1 - t7) + b4[i3] * t7;
    return c8;
  };
}
...
function genericArray(a4, b4) {
  var nb = b4 ? b4.length : 0, na = a4 ? Math.min(nb, a4.length) : 0, x5 = new Array(na), c8 = new Array(nb), i3;
  for (i3 = 0; i3 < na; ++i3)
...
function date_default(a4, b4) {
  ...
  return a4 = +a4, b4 = +b4, function(t7) {
    return d3.setTime(a4 * (1 - t7) + b4 * t7), d3;
  };
}
...
function string_default(a4, b4) {
  ...
  return s4.length < 2 ? q[0] ? one(q[0].x) : zero(b4) : (b4 = q.length, function(t7) {
    for (var i4 = 0, o3; i4 < b4; ++i4)
      s4[(o3 = q[i4]).i] = o3.x(t7);
    return s4.join("");
  });
}
...
function decompose_default(a4, b4, c8, d3, e6, f4) {
  var scaleX, scaleY, skewX;
  if (scaleX = Math.sqrt(a4 * a4 + b4 * b4))
    a4 /= scaleX, b4 /= scaleX;
  if (skewX = a4 * c8 + b4 * d3)
    c8 -= a4 * skewX, d3 -= b4 * skewX;
  if (scaleY = Math.sqrt(c8 * c8 + d3 * d3))
    c8 /= scaleY, d3 /= scaleY, skewX /= scaleY;
  if (a4 * d3 < b4 * c8)
...
function interpolateTransform(parse, pxComma, pxParen, degParen) {
  ...
  function rotate(a4, b4, s4, q) {
    if (a4 !== b4) {
      if (a4 - b4 > 180)
        b4 += 360;
      else if (b4 - a4 > 180)
        a4 += 360;
      q.push({ i: s4.push(pop(s4) + "rotate(", null, degParen) - 2, x: number_default(a4, b4) });
    } else if (b4) {
      s4.push(pop(s4) + "rotate(" + b4 + degParen);
    }
  }
  function skewX(a4, b4, s4, q) {
    if (a4 !== b4) {
      q.push({ i: s4.push(pop(s4) + "skewX(", null, degParen) - 2, x: number_default(a4, b4) });
    } else if (b4) {
  ...
  return function(a4, b4) {
    var s4 = [], q = [];
    a4 = parse(a4), b4 = parse(b4);
    translate(a4.translateX, a4.translateY, b4.translateX, b4.translateY, s4, q);
    rotate(a4.rotate, b4.rotate, s4, q);
    skewX(a4.skewX, b4.skewX, s4, q);
    scale(a4.scaleX, a4.scaleY, b4.scaleX, b4.scaleY, s4, q);
    a4 = b4 = null;
    return function(t7) {
      var i3 = -1, n3 = q.length, o3;
      while (++i3 < n3)
        s4[(o3 = q[i3]).i] = o3.x(t7);
      return s4.join("");
    };
  };
}
...
var zoom_default = function zoomRho(rho, rho2, rho4) {
  function zoom(p0, p1) {
    ...
    if (d22 < epsilon2) {
      ...
      S3 = (r1 - r0) / rho;
      i3 = function(t7) {
        var s4 = t7 * S3, coshr0 = cosh(r0), u3 = w0 / (rho2 * d1) * (coshr0 * tanh(rho * s4 + r0) - sinh(r0));
        return [
          ux0 + u3 * dx,
          uy0 + u3 * dy,
...
function hsl3(hue2) {
  return function(start2, end) {
    var h3 = hue2((start2 = hsl2(start2)).h, (end = hsl2(end)).h), s4 = nogamma(start2.s, end.s), l3 = nogamma(start2.l, end.l), opacity = nogamma(start2.opacity, end.opacity);
    return function(t7) {
      start2.h = h3(t7);
      start2.s = s4(t7);
      start2.l = l3(t7);
...
function hcl2(hue2) {
  return function(start2, end) {
    var h3 = hue2((start2 = hcl(start2)).h, (end = hcl(end)).h), c8 = nogamma(start2.c, end.c), l3 = nogamma(start2.l, end.l), opacity = nogamma(start2.opacity, end.opacity);
    return function(t7) {
      start2.h = h3(t7);
      start2.c = c8(t7);
      start2.l = l3(t7);
...
function cubehelix2(hue2) {
  return function cubehelixGamma(y4) {
    ...
    function cubehelix3(start2, end) {
      var h3 = hue2((start2 = cubehelix(start2)).h, (end = cubehelix(end)).h), s4 = nogamma(start2.s, end.s), l3 = nogamma(start2.l, end.l), opacity = nogamma(start2.opacity, end.opacity);
      return function(t7) {
        start2.h = h3(t7);
        start2.s = s4(t7);
...
function ascendingComparator(f4) {
  return (d3, x5) => ascending_default(f4(d3), x5);
}
...
function shuffler(random) {
  return function shuffle(array2, i0 = 0, i1 = array2.length) {
    let m4 = i1 - (i0 = +i0);
    while (m4) {
      const i3 = random() * m4-- | 0, t7 = array2[m4 + i0];
...
function ordinal() {
  ...
  function scale(d3) {
    var key = d3 + "", i3 = index2.get(key);
    if (!i3) {
      if (unknown !== implicit)
        return unknown;
      index2.set(key, i3 = domain.push(d3));
    }
...
function polymap(domain, range, interpolate2) {
  var j2 = Math.min(domain.length, range.length) - 1, d3 = new Array(j2), r4 = new Array(j2), i3 = -1;
  ...
  while (++i3 < j2) {
    ...
    r4[i3] = interpolate2(range[i3], range[i3 + 1]);
  }
  return function(x5) {
    var i4 = bisect_default(domain, x5, 1, j2) - 1;
    return r4[i4](d3[i4](x5));
  };
}
...
function transformer() {
  var domain = unit, range = unit, interpolate2 = value_default, transform, untransform, unknown, clamp = identity2, piecewise2, output, input;
  function rescale() {
  ...
  function scale(x5) {
    return x5 == null || isNaN(x5 = +x5) ? unknown : (output || (output = piecewise2(domain.map(transform), range, interpolate2)))(transform(clamp(x5)));
  }
  scale.invert = function(y4) {
    return clamp(untransform((input || (input = piecewise2(range, domain.map(transform), number_default)))(y4)));
  };
  scale.domain = function(_) {
  ...
  scale.rangeRound = function(_) {
    return range = Array.from(_), interpolate2 = round_default, rescale();
  };
  ...
  return function(t7, u3) {
    transform = t7, untransform = u3;
    return rescale();
  };
}
function continuous() {
...
function formatGroup_default(grouping, thousands) {
  return function(value, width) {
    var i3 = value.length, t7 = [], j2 = 0, g3 = grouping[0], length = 0;
    while (i3 > 0 && g3 > 0) {
      if (length + g3 + 1 > width)
        g3 = Math.max(1, width - length);
      t7.push(value.substring(i3 -= g3, i3 + g3));
      if ((length += g3 + 1) > width)
        break;
...
function locale_default(locale3) {
  ...
  function newFormat(specifier) {
    ...
    function format2(value) {
      var valuePrefix = prefix2, valueSuffix = suffix, i3, n3, c8;
      if (type === "c") {
  ...
  function formatPrefix2(specifier, value) {
    var f4 = newFormat((specifier = formatSpecifier(specifier), specifier.type = "f", specifier)), e6 = Math.max(-8, Math.min(8, Math.floor(exponent_default(value) / 3))) * 3, k4 = Math.pow(10, -e6), prefix2 = prefixes2[8 + e6 / 3];
...
function loggish(transform) {
  ...
  scale.ticks = function(count2) {
    var d3 = domain(), u3 = d3[0], v4 = d3[d3.length - 1], r4;
    if (r4 = v4 < u3)
      i3 = u3, u3 = v4, v4 = i3;
    var i3 = logs(u3), j2 = logs(v4), p3, k4, t7, n3 = count2 == null ? 10 : +count2, z2 = [];
    if (!(base % 1) && j2 - i3 < n3) {
      i3 = Math.floor(i3), j2 = Math.ceil(j2);
      if (u3 > 0)
        for (; i3 <= j2; ++i3) {
          for (k4 = 1, p3 = pows(i3); k4 < base; ++k4) {
            t7 = p3 * k4;
            if (t7 < u3)
              continue;
            if (t7 > v4)
        ...
        for (; i3 <= j2; ++i3) {
          for (k4 = base - 1, p3 = pows(i3); k4 >= 1; --k4) {
            t7 = p3 * k4;
            if (t7 < u3)
              continue;
            if (t7 > v4)
  ...
  scale.tickFormat = function(count2, specifier) {
    ...
    if (count2 == null)
      count2 = 10;
    var k4 = Math.max(1, base * count2 / scale.ticks().length);
    return function(d3) {
      var i3 = d3 / pows(Math.round(logs(d3)));
      if (i3 * base < base - 0.5)
        i3 *= base;
...
function transformSymlog(c8) {
  return function(x5) {
    return Math.sign(x5) * Math.log1p(Math.abs(x5 / c8));
  };
}
function transformSymexp(c8) {
  return function(x5) {
    return Math.sign(x5) * Math.expm1(Math.abs(x5)) * c8;
  };
}
...
function ticker(year3, month3, week, day3, hour3, minute3) {
  ...
  function tickInterval(start2, stop2, count2) {
    ...
    const [t7, step] = tickIntervals[target / tickIntervals[i3 - 1][2] < tickIntervals[i3][2] / target ? i3 - 1 : i3];
...
year2.every = function(k4) {
  return !isFinite(k4 = Math.floor(k4)) || !(k4 > 0) ? null : newInterval2(function(date2) {
    date2.setFullYear(Math.floor(date2.getFullYear() / k4) * k4);
    date2.setMonth(0, 1);
    date2.setHours(0, 0, 0, 0);
  }, function(date2, step) {
...
function formatLocale(locale3) {
  ...
  function newParse(specifier, Z) {
    return function(string) {
      var d3 = newDate(1900, void 0, 1), i3 = parseSpecifier(d3, specifier, string += "", 0), week, day3;
      if (i3 != string.length)
        return null;
      if ("Q" in d3)
  ...
  function parseSpecifier(d3, specifier, string, j2) {
    var i3 = 0, n3 = specifier.length, m4 = string.length, c8, parse;
    while (i3 < n3) {
      if (j2 >= m4)
        return -1;
...
function formatDayOfYear(d3, p3) {
  return pad(1 + day_default2.count(year_default2(d3), d3), p3, 3);
}
...
function formatWeekNumberSunday(d3, p3) {
  return pad(sunday2.count(year_default2(d3) - 1, d3), p3, 2);
}
function dISO(d3) {
  var day3 = d3.getDay();
...
function formatWeekNumberISO(d3, p3) {
  d3 = dISO(d3);
  return pad(thursday2.count(year_default2(d3), d3) + (year_default2(d3).getDay() === 4), p3, 2);
}
function formatWeekdayNumberSunday(d3) {
  return d3.getDay();
}
function formatWeekNumberMonday(d3, p3) {
  return pad(monday2.count(year_default2(d3) - 1, d3), p3, 2);
}
...
function formatUTCDayOfYear(d3, p3) {
  return pad(1 + utcDay_default2.count(utcYear_default2(d3), d3), p3, 3);
}
...
function formatUTCWeekNumberSunday(d3, p3) {
  return pad(utcSunday2.count(utcYear_default2(d3) - 1, d3), p3, 2);
}
function UTCdISO(d3) {
...
function formatUTCWeekNumberISO(d3, p3) {
  d3 = UTCdISO(d3);
  return pad(utcThursday2.count(utcYear_default2(d3), d3) + (utcYear_default2(d3).getUTCDay() === 4), p3, 2);
}
function formatUTCWeekdayNumberSunday(d3) {
  return d3.getUTCDay();
}
function formatUTCWeekNumberMonday(d3, p3) {
  return pad(utcMonday2.count(utcYear_default2(d3) - 1, d3), p3, 2);
}
...
function colors_default(specifier) {
  var n3 = specifier.length / 6 | 0, colors2 = new Array(n3), i3 = 0;
  while (i3 < n3)
    colors2[i3] = "#" + specifier.slice(i3 * 6, ++i3 * 6);
  return colors2;
}
...
function sinebow_default(t7) {
  var x5;
  t7 = (0.5 - t7) * Math.PI;
  c6.r = 255 * (x5 = Math.sin(t7)) * x5;
  c6.g = 255 * (x5 = Math.sin(t7 + pi_1_3)) * x5;
  c6.b = 255 * (x5 = Math.sin(t7 + pi_2_3)) * x5;
  return c6 + "";
}
...
function ramp(range) {
  var n3 = range.length;
  return function(t7) {
    return range[Math.max(0, Math.min(n3 - 1, Math.floor(t7 * n3)))];
  };
}
...
Path.prototype = path.prototype = {
  ...
  rect: function(x5, y4, w3, h3) {
    this._ += "M" + (this._x0 = this._x1 = +x5) + "," + (this._y0 = this._y1 = +y4) + "h" + +w3 + "v" + +h3 + "h" + -w3 + "Z";
  },
  toString: function() {
    return this._;
  }
...
function cornerTangents(x0, y0, x1, y1, r1, rc, cw) {
  var x01 = x0 - x1, y01 = y0 - y1, lo = (cw ? rc : -rc) / sqrt2(x01 * x01 + y01 * y01), ox = lo * y01, oy = -lo * x01, x11 = x0 + ox, y11 = y0 + oy, x10 = x1 + ox, y10 = y1 + oy, x00 = (x11 + x10) / 2, y00 = (y11 + y10) / 2, dx = x10 - x11, dy = y10 - y11, d22 = dx * dx + dy * dy, r4 = r1 - rc, D2 = x11 * y10 - x10 * y11, d3 = (dy < 0 ? -1 : 1) * sqrt2(max2(0, r4 * r4 * d22 - D2 * D2)), cx0 = (D2 * dy - dx * d3) / d22, cy0 = (-D2 * dx - dy * d3) / d22, cx1 = (D2 * dy + dx * d3) / d22, cy1 = (-D2 * dx + dy * d3) / d22, dx0 = cx0 - x00, dy0 = cy0 - y00, dx1 = cx1 - x00, dy1 = cy1 - y00;
...
function arc_default() {
  ...
  arc.centroid = function() {
    var r4 = (+innerRadius.apply(this, arguments) + +outerRadius.apply(this, arguments)) / 2, a4 = (+startAngle.apply(this, arguments) + +endAngle.apply(this, arguments)) / 2 - pi2 / 2;
    return [cos(a4) * r4, sin(a4) * r4];
  };
...
function line_default() {
  var x5 = x, y4 = y, defined = constant_default3(true), context = null, curve = linear_default, output = null;
  function line(data) {
    var i3, n3 = data.length, d3, defined0 = false, buffer;
    if (context == null)
    ...
    for (i3 = 0; i3 <= n3; ++i3) {
      ...
      if (defined0)
        output.point(+x5(d3, i3, data), +y4(d3, i3, data));
    }
    if (buffer)
      return output = null, buffer + "" || null;
  }
  line.x = function(_) {
    return arguments.length ? (x5 = typeof _ === "function" ? _ : constant_default3(+_), line) : x5;
  };
  line.y = function(_) {
...
function area_default() {
  ...
  function area(data) {
    var i3, j2, k4, n3 = data.length, d3, defined0 = false, buffer, x0z = new Array(n3), y0z = new Array(n3);
    if (context == null)
      output = curve(buffer = path_default());
    for (i3 = 0; i3 <= n3; ++i3) {
      if (!(i3 < n3 && defined(d3 = data[i3], i3, data)) === defined0) {
...
function descending_default2(a4, b4) {
...
function pie_default() {
  ...
  function pie(data) {
    var i3, n3 = data.length, j2, k4, sum3 = 0, index2 = new Array(n3), arcs = new Array(n3), a0 = +startAngle.apply(this, arguments), da = Math.min(tau2, Math.max(-tau2, endAngle.apply(this, arguments) - a0)), a1, p3 = Math.min(Math.abs(da) / n3, padAngle.apply(this, arguments)), pa = p3 * (da < 0 ? -1 : 1), v4;
    for (i3 = 0; i3 < n3; ++i3) {
      if ((v4 = arcs[index2[i3] = i3] = +value(data[i3], i3, data)) > 0) {
        sum3 += v4;
      }
    }
    if (sortValues != null)
    ...
    for (i3 = 0, k4 = sum3 ? (da - n3 * pa) / sum3 : 0; i3 < n3; ++i3, a0 = a1) {
      j2 = index2[i3], v4 = arcs[j2], a1 = a0 + (v4 > 0 ? v4 * k4 : 0) + pa, arcs[j2] = {
        data: data[j2],
        index: i3,
        value: v4,
        startAngle: a0,
...
Bundle.prototype = {
  ...
  lineEnd: function() {
    var x5 = this._x, y4 = this._y, j2 = x5.length - 1;
    if (j2 > 0) {
      var x0 = x5[0], y0 = y4[0], dx = x5[j2] - x0, dy = y4[j2] - y0, i3 = -1, t7;
      while (++i3 <= j2) {
        t7 = i3 / j2;
        this._basis.point(
          this._beta * x5[i3] + (1 - this._beta) * (x0 + t7 * dx),
          this._beta * y4[i3] + (1 - this._beta) * (y0 + t7 * dy)
        );
      }
    }
...
MonotoneX.prototype = {
  ...
  point: function(x5, y4) {
    ...
    switch (this._point) {
      ...
      case 2:
        this._point = 3;
        point5(this, slope2(this, t14 = slope3(this, x5, y4)), t14);
        break;
      default:
        point5(this, this._t0, t14 = slope3(this, x5, y4));
        break;
    }
    this._x0 = this._x1, this._x1 = x5;
    this._y0 = this._y1, this._y1 = y4;
...
function controlPoints(x5) {
  var i3, n3 = x5.length - 1, m4, a4 = new Array(n3), b4 = new Array(n3), r4 = new Array(n3);
  a4[0] = 0, b4[0] = 2, r4[0] = x5[0] + 2 * x5[1];
  for (i3 = 1; i3 < n3 - 1; ++i3)
    a4[i3] = 1, b4[i3] = 4, r4[i3] = 4 * x5[i3] + 2 * x5[i3 + 1];
  a4[n3 - 1] = 2, b4[n3 - 1] = 7, r4[n3 - 1] = 8 * x5[n3 - 1] + x5[n3];
  for (i3 = 1; i3 < n3; ++i3)
    m4 = a4[i3] / b4[i3 - 1], b4[i3] -= m4, r4[i3] -= m4 * r4[i3 - 1];
  a4[n3 - 1] = r4[n3 - 1] / b4[n3 - 1];
  for (i3 = n3 - 2; i3 >= 0; --i3)
    a4[i3] = (r4[i3] - a4[i3 + 1]) / b4[i3];
  b4[n3 - 1] = (x5[n3] + a4[n3 - 1]) / 2;
  for (i3 = 0; i3 < n3 - 1; ++i3)
...
function none_default(series, order) {
  if (!((n3 = series.length) > 1))
    return;
  for (var i3 = 1, j2, s0, s1 = series[order[0]], n3, m4 = s1.length; i3 < n3; ++i3) {
...
function expand_default(series, order) {
  if (!((n3 = series.length) > 0))
    return;
  for (var i3, n3, j2 = 0, m4 = series[0].length, y4; j2 < m4; ++j2) {
...
function diverging_default(series, order) {
  if (!((n3 = series.length) > 0))
    return;
  for (var i3, j2 = 0, d3, dy, yp, yn, n3, m4 = series[order[0]].length; j2 < m4; ++j2) {
    for (yp = yn = 0, i3 = 0; i3 < n3; ++i3) {
      if ((dy = (d3 = series[order[i3]][j2])[1] - d3[0]) > 0) {
        d3[0] = yp, d3[1] = yp += dy;
      } else if (dy < 0) {
        d3[1] = yn, d3[0] = yn += dy;
      } else {
...
function silhouette_default(series, order) {
  if (!((n3 = series.length) > 0))
    return;
  for (var j2 = 0, s0 = series[order[0]], n3, m4 = s0.length; j2 < m4; ++j2) {
...
function wiggle_default(series, order) {
  if (!((n3 = series.length) > 0) || !((m4 = (s0 = series[order[0]]).length) > 0))
    return;
  for (var y4 = 0, j2 = 1, s0, m4, n3; j2 < m4; ++j2) {
    for (var i3 = 0, s1 = 0, s22 = 0; i3 < n3; ++i3) {
      var si2 = series[order[i3]], sij0 = si2[j2][1] || 0, sij1 = si2[j2 - 1][1] || 0, s32 = (sij0 - sij1) / 2;
...
function Gr() {
  return Gr = Object.assign || function(e6) {
    for (var r4 = 1; r4 < arguments.length; r4++) {
      var t7 = arguments[r4];
      for (var i3 in t7)
        Object.prototype.hasOwnProperty.call(t7, i3) && (e6[i3] = t7[i3]);
    }
    return e6;
  }, Gr.apply(this, arguments);
}
function Br(e6, r4) {
  return Br = Object.setPrototypeOf || function(e7, r5) {
    return e7.__proto__ = r5, e7;
  }, Br(e6, r4);
}
function Lr(e6, r4) {
  if (null == e6)
    return {};
  var t7, i3, n3 = {}, o3 = Object.keys(e6);
  for (i3 = 0; i3 < o3.length; i3++)
    t7 = o3[i3], r4.indexOf(t7) >= 0 || (n3[t7] = e6[t7]);
  return n3;
}
...
var Qr = function(e6, r4) {
  var t7 = (0, import_merge2.default)({}, e6, r4);
  return Jr.forEach(function(e7) {
    void 0 === (0, import_get.default)(t7, e7 + ".fontFamily") && (0, import_set2.default)(t7, e7 + ".fontFamily", t7.fontFamily), void 0 === (0, import_get.default)(t7, e7 + ".fontSize") && (0, import_set2.default)(t7, e7 + ".fontSize", t7.fontSize), void 0 === (0, import_get.default)(t7, e7 + ".fill") && (0, import_set2.default)(t7, e7 + ".fill", t7.textColor);
  }), t7;
};
var Zr = (0, import_react5.createContext)();
var $r = function(e6) {
  var t7 = e6.children, i3 = e6.animate, n3 = e6.stiffness, o3 = e6.damping, a4 = e6.config, s4 = (0, import_react5.useMemo)(function() {
    var e7 = (0, import_isString.default)(a4) ? config[a4] : a4;
    return { animate: i3, springConfig: { stiffness: n3, damping: o3 }, config: e7 };
  }, [i3, n3, o3, a4]);
  return (0, import_jsx_runtime.jsx)(Zr.Provider, { value: s4, children: t7 });
};
...
$r.defaultProps = rt;
var tt = function() {
  return (0, import_react5.useContext)(Zr);
};
var it = function(e6) {
  var t7 = tt(), o3 = t7.animate, a4 = t7.config, s4 = function(e7) {
    var r4 = (0, import_react5.useRef)();
    return (0, import_react5.useEffect)(function() {
      r4.current = e7;
    }, [e7]), r4.current;
  }(e6), l3 = (0, import_react5.useMemo)(function() {
    return string_default(s4, e6);
  }, [s4, e6]), d3 = useSpring({ from: { value: 0 }, to: { value: 1 }, reset: true, config: a4, immediate: !o3 }).value;
  return to2(d3, l3);
};
...
var At = function(e6, t7, i3) {
  return void 0 === i3 && (i3 = {}), (0, import_react5.useMemo)(function() {
    var r4 = Gr({}, Yt, i3);
    return { margin: r4, innerWidth: e6 - r4.left - r4.right, innerHeight: t7 - r4.top - r4.bottom, outerWidth: e6, outerHeight: t7 };
  }, [e6, t7, i3.top, i3.right, i3.bottom, i3.left]);
};
var Ft = function() {
  var e6 = (0, import_react5.useRef)(null), r4 = (0, import_react5.useState)({ left: 0, top: 0, width: 0, height: 0 }), t7 = r4[0], a4 = r4[1], s4 = (0, import_react5.useState)(function() {
    return "undefined" != typeof window ? new ResizeObserver(function(e7) {
      var r5 = e7[0];
      return a4(r5.contentRect);
    }) : null;
  })[0];
  return (0, import_react5.useEffect)(function() {
    return e6.current && null !== s4 && s4.observe(e6.current), function() {
      null !== s4 && s4.disconnect();
    };
  }, []), [e6, t7];
};
var Et = function(e6) {
...
var Kt = (0, import_react5.createContext)();
var Ht = {};
var Nt = function(e6) {
  var r4 = e6.theme, t7 = void 0 === r4 ? Ht : r4, i3 = e6.children, n3 = Et(t7);
...
var Vt = function() {
  return (0, import_react5.useContext)(Kt);
};
var Jt = function(e6) {
  var r4 = e6.children, t7 = e6.condition, i3 = e6.wrapper;
  return t7 ? (0, import_react5.cloneElement)(i3, {}, r4) : r4;
};
...
var Zt = function(e6) {
  var r4 = e6.children, t7 = e6.theme, n3 = e6.renderWrapper, o3 = void 0 === n3 || n3, a4 = e6.isInteractive, s4 = void 0 === a4 || a4, l3 = e6.animate, d3 = e6.motionStiffness, u3 = e6.motionDamping, f4 = e6.motionConfig, h3 = (0, import_react5.useRef)(null);
  return (0, import_jsx_runtime.jsx)(Nt, { theme: t7, children: (0, import_jsx_runtime.jsx)($r, { animate: l3, stiffness: d3, damping: u3, config: f4, children: (0, import_jsx_runtime.jsx)(M, { container: h3, children: (0, import_jsx_runtime.jsxs)(Jt, { condition: o3, wrapper: (0, import_jsx_runtime.jsx)("div", { style: Qt, ref: h3 }), children: [r4, s4 && (0, import_jsx_runtime.jsx)(F, {})] }) }) }) });
};
...
var ri = function(e6) {
  var t7 = e6.children, n3 = e6.theme, o3 = e6.isInteractive, a4 = void 0 === o3 || o3, l3 = e6.renderWrapper, d3 = void 0 === l3 || l3, u3 = e6.animate, f4 = e6.motionStiffness, c8 = e6.motionDamping, b4 = e6.motionConfig, y4 = (0, import_react5.useRef)(null), v4 = O(y4), R = v4.actions, q = v4.state, k4 = (0, import_react5.useCallback)(function(e7, r4) {
    return R.showTooltipFromEvent(e7, r4);
  }, [R.showTooltipFromEvent]), _ = (0, import_react5.useMemo)(function() {
    return { showTooltip: a4 ? k4 : $t, hideTooltip: a4 ? R.hideTooltip : $t };
  }, [R.hideTooltip, a4, k4]);
  return (0, import_jsx_runtime.jsx)(Nt, { theme: n3, children: (0, import_jsx_runtime.jsx)($r, { animate: u3, stiffness: f4, damping: c8, config: b4, children: (0, import_jsx_runtime.jsx)(N.Provider, { value: R, children: (0, import_jsx_runtime.jsx)(j.Provider, { value: q, children: (0, import_jsx_runtime.jsxs)(Jt, { condition: d3, wrapper: (0, import_jsx_runtime.jsx)("div", { style: ei, ref: y4 }), children: [t7(_), a4 && (0, import_jsx_runtime.jsx)(F, {})] }) }) }) }) });
};
...
var ti = function(e6) {
  var r4 = e6.children, t7 = Ft(), i3 = t7[0], n3 = t7[1], o3 = n3.width > 0 && n3.height > 0;
...
var ii = ["id", "colors"];
var ni = function(e6) {
  var r4 = e6.id, t7 = e6.colors, i3 = Lr(e6, ii);
  return (0, import_jsx_runtime.jsx)("linearGradient", Gr({ id: r4, x1: 0, x2: 0, y1: 0, y2: 1 }, i3, { children: t7.map(function(e7) {
    var r5 = e7.offset, t8 = e7.color, i4 = e7.opacity;
    return (0, import_jsx_runtime.jsx)("stop", { offset: r5 + "%", stopColor: t8, stopOpacity: void 0 !== i4 ? i4 : 1 }, r5);
  }) }));
};
...
var si = (0, import_react5.memo)(function(e6) {
  var r4 = e6.id, t7 = e6.background, i3 = e6.color, n3 = e6.size, o3 = e6.padding, a4 = e6.stagger, s4 = n3 + o3, l3 = n3 / 2, d3 = o3 / 2;
  return true === a4 && (s4 = 2 * n3 + 2 * o3), (0, import_jsx_runtime.jsxs)("pattern", { id: r4, width: s4, height: s4, patternUnits: "userSpaceOnUse", children: [(0, import_jsx_runtime.jsx)("rect", { width: s4, height: s4, fill: t7 }), (0, import_jsx_runtime.jsx)("circle", { cx: d3 + l3, cy: d3 + l3, r: l3, fill: i3 }), a4 && (0, import_jsx_runtime.jsx)("circle", { cx: 1.5 * o3 + n3 + l3, cy: 1.5 * o3 + n3 + l3, r: l3, fill: i3 })] });
});
...
var ci = function(e6) {
  return e6.startAngle + (e6.endAngle - e6.startAngle) / 2;
};
var pi3 = function(e6, r4) {
  return { x: Math.cos(e6) * r4, y: Math.sin(e6) * r4 };
};
...
var Ri = (0, import_react5.memo)(function(e6) {
  var r4 = e6.id, t7 = e6.spacing, i3 = e6.rotation, n3 = e6.background, o3 = e6.color, a4 = e6.lineWidth, s4 = Math.round(i3) % 360, l3 = Math.abs(t7);
  s4 > 180 ? s4 -= 360 : s4 > 90 ? s4 -= 180 : s4 < -180 ? s4 += 360 : s4 < -90 && (s4 += 180);
  var d3, u3 = l3, f4 = l3;
  return 0 === s4 ? d3 = "\n                M 0 0 L " + u3 + " 0\n                M 0 " + f4 + " L " + u3 + " " + f4 + "\n            " : 90 === s4 ? d3 = "\n                M 0 0 L 0 " + f4 + "\n                M " + u3 + " 0 L " + u3 + " " + f4 + "\n            " : (u3 = Math.abs(l3 / Math.sin(ui(s4))), f4 = l3 / Math.sin(ui(90 - s4)), d3 = s4 > 0 ? "\n                    M 0 " + -f4 + " L " + 2 * u3 + " " + f4 + "\n                    M " + -u3 + " " + -f4 + " L " + u3 + " " + f4 + "\n                    M " + -u3 + " 0 L " + u3 + " " + 2 * f4 + "\n                " : "\n                    M " + -u3 + " " + f4 + " L " + u3 + " " + -f4 + "\n                    M " + -u3 + " " + 2 * f4 + " L " + 2 * u3 + " " + -f4 + "\n                    M 0 " + 2 * f4 + " L " + 2 * u3 + " 0\n                "), (0, import_jsx_runtime.jsxs)("pattern", { id: r4, width: u3, height: f4, patternUnits: "userSpaceOnUse", children: [(0, import_jsx_runtime.jsx)("rect", { width: u3, height: f4, fill: n3, stroke: "rgba(255, 0, 0, 0.1)", strokeWidth: 0 }), (0, import_jsx_runtime.jsx)("path", { d: d3, strokeWidth: a4, stroke: o3, strokeLinecap: "square" })] });
});
...
var ki = (0, import_react5.memo)(function(e6) {
  var r4 = e6.id, t7 = e6.background, i3 = e6.color, n3 = e6.size, o3 = e6.padding, a4 = e6.stagger, s4 = n3 + o3, l3 = o3 / 2;
...
var Ci = function(e6) {
  var r4 = e6.defs;
  return !r4 || r4.length < 1 ? null : (0, import_jsx_runtime.jsx)("defs", { "aria-hidden": true, children: r4.map(function(e7) {
    var r5 = e7.type, t7 = Lr(e7, xi);
    return Oi[r5] ? (0, import_react5.createElement)(Oi[r5], Gr({ key: t7.id }, t7)) : null;
  }) });
};
...
var Wi = (0, import_react5.memo)(Ci);
var Si = function(e6) {
  var r4 = e6.width, t7 = e6.height, i3 = e6.margin, n3 = e6.defs, o3 = e6.children, a4 = e6.role, s4 = e6.ariaLabel, l3 = e6.ariaLabelledBy, d3 = e6.ariaDescribedBy, u3 = e6.isFocusable, f4 = Vt();
  return (0, import_jsx_runtime.jsxs)("svg", { xmlns: "http://www.w3.org/2000/svg", width: r4, height: t7, role: a4, "aria-label": s4, "aria-labelledby": l3, "aria-describedby": d3, focusable: u3, tabIndex: u3 ? 0 : void 0, children: [(0, import_jsx_runtime.jsx)(Wi, { defs: n3 }), (0, import_jsx_runtime.jsx)("rect", { width: r4, height: t7, fill: f4.background }), (0, import_jsx_runtime.jsx)("g", { transform: "translate(" + i3.left + "," + i3.top + ")", children: o3 })] });
};
...
var zi = function(e6) {
  var r4 = e6.size, t7 = e6.color, i3 = e6.borderWidth, n3 = e6.borderColor;
  return (0, import_jsx_runtime.jsx)("circle", { r: r4 / 2, fill: t7, stroke: n3, strokeWidth: i3, style: { pointerEvents: "none" } });
};
...
var Pi = (0, import_react5.memo)(zi);
var Ti = function(e6) {
  var r4 = e6.x, t7 = e6.y, i3 = e6.symbol, n3 = void 0 === i3 ? Pi : i3, o3 = e6.size, a4 = e6.datum, s4 = e6.color, l3 = e6.borderWidth, u3 = e6.borderColor, f4 = e6.label, c8 = e6.labelTextAnchor, p3 = void 0 === c8 ? "middle" : c8, h3 = e6.labelYOffset, g3 = void 0 === h3 ? -12 : h3, m4 = Vt(), b4 = tt(), y4 = b4.animate, v4 = b4.config, R = useSpring({ transform: "translate(" + r4 + ", " + t7 + ")", config: v4, immediate: !y4 });
  return (0, import_jsx_runtime.jsxs)(animated.g, { transform: R.transform, style: { pointerEvents: "none" }, children: [(0, import_react5.createElement)(n3, { size: o3, color: s4, datum: a4, borderWidth: l3, borderColor: u3 }), f4 && (0, import_jsx_runtime.jsx)("text", { textAnchor: p3, y: g3, style: m4.dots.text, children: f4 })] });
};
...
var Mi = (0, import_react5.memo)(Ti);
var ji = function(e6) {
  var r4 = e6.width, t7 = e6.height, i3 = e6.axis, n3 = e6.scale, o3 = e6.value, a4 = e6.lineStyle, s4 = e6.textStyle, l3 = e6.legend, d3 = e6.legendPosition, u3 = e6.legendOffsetX, f4 = e6.legendOffsetY, c8 = e6.legendOrientation, p3 = Vt(), h3 = 0, g3 = 0, m4 = 0, b4 = 0;
  "y" === i3 ? (m4 = n3(o3), g3 = r4) : (h3 = n3(o3), b4 = t7);
  var y4 = null;
  if (l3) {
    var v4 = function(e7) {
      var r5 = e7.axis, t8 = e7.width, i4 = e7.height, n4 = e7.position, o4 = e7.offsetX, a5 = e7.offsetY, s5 = e7.orientation, l4 = 0, d4 = 0, u4 = "vertical" === s5 ? -90 : 0, f5 = "start";
      if ("x" === r5)
        switch (n4) {
          case "top-left":
            l4 = -o4, d4 = a5, f5 = "end";
            break;
          case "top":
            d4 = -a5, f5 = "horizontal" === s5 ? "middle" : "start";
            break;
          case "top-right":
            l4 = o4, d4 = a5, f5 = "horizontal" === s5 ? "start" : "end";
            break;
          case "right":
            l4 = o4, d4 = i4 / 2, f5 = "horizontal" === s5 ? "start" : "middle";
            break;
          case "bottom-right":
            l4 = o4, d4 = i4 - a5, f5 = "start";
            break;
          case "bottom":
            d4 = i4 + a5, f5 = "horizontal" === s5 ? "middle" : "end";
            break;
          case "bottom-left":
            d4 = i4 - a5, l4 = -o4, f5 = "horizontal" === s5 ? "end" : "start";
            break;
          case "left":
            l4 = -o4, d4 = i4 / 2, f5 = "horizontal" === s5 ? "end" : "middle";
        }
      else
        switch (n4) {
          case "top-left":
            l4 = o4, d4 = -a5, f5 = "start";
            break;
          case "top":
            l4 = t8 / 2, d4 = -a5, f5 = "horizontal" === s5 ? "middle" : "start";
            break;
          case "top-right":
            l4 = t8 - o4, d4 = -a5, f5 = "horizontal" === s5 ? "end" : "start";
            break;
          case "right":
            l4 = t8 + o4, f5 = "horizontal" === s5 ? "start" : "middle";
            break;
          case "bottom-right":
            l4 = t8 - o4, d4 = a5, f5 = "end";
            break;
          case "bottom":
            l4 = t8 / 2, d4 = a5, f5 = "horizontal" === s5 ? "middle" : "end";
            break;
          case "bottom-left":
            l4 = o4, d4 = a5, f5 = "horizontal" === s5 ? "start" : "end";
            break;
          case "left":
            l4 = -o4, f5 = "horizontal" === s5 ? "end" : "middle";
        }
      return { x: l4, y: d4, rotation: u4, textAnchor: f5 };
    }({ axis: i3, width: r4, height: t7, position: d3, offsetX: u3, offsetY: f4, orientation: c8 });
    y4 = (0, import_jsx_runtime.jsx)("text", { transform: "translate(" + v4.x + ", " + v4.y + ") rotate(" + v4.rotation + ")", textAnchor: v4.textAnchor, dominantBaseline: "central", style: s4, children: l3 });
  }
  return (0, import_jsx_runtime.jsxs)("g", { transform: "translate(" + h3 + ", " + m4 + ")", children: [(0, import_jsx_runtime.jsx)("line", { x1: 0, x2: g3, y1: 0, y2: b4, stroke: p3.markers.lineColor, strokeWidth: p3.markers.lineStrokeWidth, style: a4 }), y4] });
};
...
var Di = (0, import_react5.memo)(ji);
var Gi = function(e6) {
  var r4 = e6.markers, t7 = e6.width, i3 = e6.height, n3 = e6.xScale, o3 = e6.yScale;
  return r4 && 0 !== r4.length ? r4.map(function(e7, r5) {
    return (0, import_jsx_runtime.jsx)(Di, Gr({}, e7, { width: t7, height: i3, scale: "y" === e7.axis ? o3 : n3 }), r5);
  }) : null;
};
...
var Bi = (0, import_react5.memo)(Gi);
...
var Fi = function(e6) {
  return function(r4) {
    ...
    return i3 = r4, (t7 = n3).prototype = Object.create(i3.prototype), t7.prototype.constructor = t7, Br(t7, i3), n3.prototype.render = function() {
      var r5 = this.props, t8 = r5.theme, i4 = r5.renderWrapper, n4 = r5.animate, o3 = r5.motionStiffness, a4 = r5.motionDamping, s4 = r5.motionConfig, l3 = Lr(r5, Ai);
      return (0, import_jsx_runtime.jsx)(Zt, { theme: t8, renderWrapper: i4, isInteractive: l3.isInteractive, animate: n4, motionStiffness: o3, motionDamping: a4, motionConfig: s4, children: (0, import_jsx_runtime.jsx)(e6, Gr({}, l3)) });
    }, n3;
  }(import_react5.Component);
};
var Ei = function(e6, r4) {
  var t7, i3 = (0, import_isFunction.default)(e6) ? e6 : function(r5) {
    return (0, import_get.default)(r5, e6);
  };
  return r4 && (t7 = (0, import_isFunction.default)(r4) ? r4 : format(r4)), t7 ? function(e7) {
    return t7(i3(e7));
  } : i3;
};
var Ui = function(e6) {
  return (0, import_isFunction.default)(e6) ? e6 : function(r4) {
...
var Ni = function(e6, r4, t7, i3) {
  var n3 = t7 - e6, o3 = i3 - r4;
  return n3 *= n3, o3 *= o3, Math.sqrt(n3 + o3);
};
var Vi = function(e6, r4, t7, i3) {
  var n3 = Math.atan2(i3 - r4, t7 - e6) - Math.PI / 2;
  return n3 > 0 ? n3 : 2 * Math.PI + n3;
};
var Ji = function(e6, r4, t7, i3, n3, o3) {
  return e6 <= n3 && n3 <= e6 + t7 && r4 <= o3 && o3 <= r4 + i3;
};
var Qi = function(e6, r4) {
  var t7 = r4.clientX, i3 = r4.clientY, n3 = e6.getBoundingClientRect(), o3 = e6.getBBox(), a4 = o3.width === n3.width ? 1 : o3.width / n3.width;
  return [(t7 - n3.left) * a4, (i3 - n3.top) * a4];
};
var Zi = Object.keys(ai);
var $i = Object.keys(wi);
var en = function(e6, r4, t7) {
  if ("*" === e6)
    return true;
  if ((0, import_isFunction.default)(e6))
    return e6(r4);
  if ((0, import_isPlainObject.default)(e6)) {
    var i3 = t7 ? (0, import_get.default)(r4, t7) : r4;
    return (0, import_isEqual.default)((0, import_pick.default)(i3, Object.keys(e6)), e6);
  }
  return false;
};
var rn = function(e6, r4, t7, i3) {
  var n3 = void 0 === i3 ? {} : i3, o3 = n3.dataKey, a4 = n3.colorKey, s4 = void 0 === a4 ? "color" : a4, l3 = n3.targetKey, d3 = void 0 === l3 ? "fill" : l3, u3 = [], f4 = {};
  return e6.length && r4.length && (u3 = [].concat(e6), r4.forEach(function(r5) {
    for (var i4 = function(i5) {
      var n5 = t7[i5], a5 = n5.id, l4 = n5.match;
      if (en(l4, r5, o3)) {
        var c8 = e6.find(function(e7) {
          return e7.id === a5;
        });
        if (c8) {
          if ($i.includes(c8.type))
            if ("inherit" === c8.background || "inherit" === c8.color) {
              var p3 = (0, import_get.default)(r5, s4), h3 = c8.background, g3 = c8.color, m4 = a5;
              "inherit" === c8.background && (m4 = m4 + ".bg." + p3, h3 = p3), "inherit" === c8.color && (m4 = m4 + ".fg." + p3, g3 = p3), (0, import_set2.default)(r5, d3, "url(#" + m4 + ")"), f4[m4] || (u3.push(Gr({}, c8, { id: m4, background: h3, color: g3 })), f4[m4] = 1);
            } else
              (0, import_set2.default)(r5, d3, "url(#" + a5 + ")");
          else if (Zi.includes(c8.type)) {
            if (c8.colors.map(function(e7) {
              return e7.color;
            }).includes("inherit")) {
              var b4 = (0, import_get.default)(r5, s4), R = a5, q = Gr({}, c8, { colors: c8.colors.map(function(e7, r6) {
                return "inherit" !== e7.color ? e7 : (R = R + "." + r6 + "." + b4, Gr({}, e7, { color: "inherit" === e7.color ? b4 : e7.color }));
              }) });
              q.id = R, (0, import_set2.default)(r5, d3, "url(#" + R + ")"), f4[R] || (u3.push(q), f4[R] = 1);
            } else
              (0, import_set2.default)(r5, d3, "url(#" + a5 + ")");
          }
        }
...
function v2() {
  return v2 = Object.assign || function(t7) {
    for (var i3 = 1; i3 < arguments.length; i3++) {
      var o3 = arguments[i3];
      for (var n3 in o3)
        Object.prototype.hasOwnProperty.call(o3, n3) && (t7[n3] = o3[n3]);
    }
    return t7;
  }, v2.apply(this, arguments);
}
var x3 = { pointerEvents: "none", position: "absolute", zIndex: 10, top: 0, left: 0 };
var m2 = function(t7, i3) {
  return "translate(" + t7 + "px, " + i3 + "px)";
};
var g = (0, import_react6.memo)(function(t7) {
  var o3, n3 = t7.position, r4 = t7.anchor, e6 = t7.children, l3 = Vt(), u3 = tt(), p3 = u3.animate, f4 = u3.config, g3 = Ft(), b4 = g3[0], w3 = g3[1], T3 = (0, import_react6.useRef)(false), C4 = void 0, E3 = false, P3 = w3.width > 0 && w3.height > 0, N2 = Math.round(n3[0]), V2 = Math.round(n3[1]);
  P3 && ("top" === r4 ? (N2 -= w3.width / 2, V2 -= w3.height + 14) : "right" === r4 ? (N2 += 14, V2 -= w3.height / 2) : "bottom" === r4 ? (N2 -= w3.width / 2, V2 += 14) : "left" === r4 ? (N2 -= w3.width + 14, V2 -= w3.height / 2) : "center" === r4 && (N2 -= w3.width / 2, V2 -= w3.height / 2), C4 = { transform: m2(N2, V2) }, T3.current || (E3 = true), T3.current = [N2, V2]);
  var j2 = useSpring({ to: C4, config: f4, immediate: !p3 || E3 }), O5 = v2({}, x3, l3.tooltip, { transform: null != (o3 = j2.transform) ? o3 : m2(N2, V2) });
  return (0, import_jsx_runtime2.jsx)(animated.div, { ref: b4, style: O5, children: e6 });
});
g.displayName = "TooltipWrapper";
var b2 = (0, import_react6.memo)(function(t7) {
  var i3 = t7.size, o3 = void 0 === i3 ? 12 : i3, n3 = t7.color, r4 = t7.style;
  return (0, import_jsx_runtime2.jsx)("span", { style: v2({ display: "block", width: o3, height: o3, background: n3 }, void 0 === r4 ? {} : r4) });
});
var w = (0, import_react6.memo)(function(t7) {
  var i3, o3 = t7.id, n3 = t7.value, r4 = t7.format, e6 = t7.enableChip, l3 = void 0 !== e6 && e6, a4 = t7.color, c8 = t7.renderContent, s4 = Vt(), d3 = Xt(r4);
  if ("function" == typeof c8)
    i3 = c8();
  else {
    var f4 = n3;
    void 0 !== d3 && void 0 !== f4 && (f4 = d3(f4)), i3 = (0, import_jsx_runtime2.jsxs)("div", { style: s4.tooltip.basic, children: [l3 && (0, import_jsx_runtime2.jsx)(b2, { color: a4, style: s4.tooltip.chip }), void 0 !== f4 ? (0, import_jsx_runtime2.jsxs)("span", { children: [o3, ": ", (0, import_jsx_runtime2.jsx)("strong", { children: "" + f4 })] }) : o3] });
  }
  return (0, import_jsx_runtime2.jsx)("div", { style: s4.tooltip.container, children: i3 });
});
var T = { width: "100%", borderCollapse: "collapse" };
var C3 = (0, import_react6.memo)(function(t7) {
  var i3, o3 = t7.title, n3 = t7.rows, r4 = void 0 === n3 ? [] : n3, e6 = t7.renderContent, l3 = Vt();
  return r4.length ? (i3 = "function" == typeof e6 ? e6() : (0, import_jsx_runtime2.jsxs)("div", { children: [o3 && o3, (0, import_jsx_runtime2.jsx)("table", { style: v2({}, T, l3.tooltip.table), children: (0, import_jsx_runtime2.jsx)("tbody", { children: r4.map(function(t8, i4) {
    return (0, import_jsx_runtime2.jsx)("tr", { children: t8.map(function(t9, i5) {
      return (0, import_jsx_runtime2.jsx)("td", { style: l3.tooltip.tableCell, children: t9 }, i5);
    }) }, i4);
  }) }) })] }), (0, import_jsx_runtime2.jsx)("div", { style: l3.tooltip.container, children: i3 })) : null;
});
C3.displayName = "TableTooltip";
var E2 = (0, import_react6.memo)(function(t7) {
  var i3 = t7.x0, n3 = t7.x1, r4 = t7.y0, e6 = t7.y1, l3 = Vt(), d3 = tt(), u3 = d3.animate, p3 = d3.config, f4 = (0, import_react6.useMemo)(function() {
    return v2({}, l3.crosshair.line, { pointerEvents: "none" });
  }, [l3.crosshair.line]), x5 = useSpring({ x1: i3, x2: n3, y1: r4, y2: e6, config: p3, immediate: !u3 });
  return (0, import_jsx_runtime2.jsx)(animated.line, v2({}, x5, { fill: "none", style: f4 }));
});
E2.displayName = "CrosshairLine";
var P2 = (0, import_react6.memo)(function(t7) {
  var i3, o3, n3 = t7.width, r4 = t7.height, e6 = t7.type, l3 = t7.x, a4 = t7.y;
  return "cross" === e6 ? (i3 = { x0: l3, x1: l3, y0: 0, y1: r4 }, o3 = { x0: 0, x1: n3, y0: a4, y1: a4 }) : "top-left" === e6 ? (i3 = { x0: l3, x1: l3, y0: 0, y1: a4 }, o3 = { x0: 0, x1: l3, y0: a4, y1: a4 }) : "top" === e6 ? i3 = { x0: l3, x1: l3, y0: 0, y1: a4 } : "top-right" === e6 ? (i3 = { x0: l3, x1: l3, y0: 0, y1: a4 }, o3 = { x0: l3, x1: n3, y0: a4, y1: a4 }) : "right" === e6 ? o3 = { x0: l3, x1: n3, y0: a4, y1: a4 } : "bottom-right" === e6 ? (i3 = { x0: l3, x1: l3, y0: a4, y1: r4 }, o3 = { x0: l3, x1: n3, y0: a4, y1: a4 }) : "bottom" === e6 ? i3 = { x0: l3, x1: l3, y0: a4, y1: r4 } : "bottom-left" === e6 ? (i3 = { x0: l3, x1: l3, y0: a4, y1: r4 }, o3 = { x0: 0, x1: l3, y0: a4, y1: a4 }) : "left" === e6 ? o3 = { x0: 0, x1: l3, y0: a4, y1: a4 } : "x" === e6 ? i3 = { x0: l3, x1: l3, y0: 0, y1: r4 } : "y" === e6 && (o3 = { x0: 0, x1: n3, y0: a4, y1: a4 }), (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [i3 && (0, import_jsx_runtime2.jsx)(E2, { x0: i3.x0, x1: i3.x1, y0: i3.y0, y1: i3.y1 }), o3 && (0, import_jsx_runtime2.jsx)(E2, { x0: o3.x0, x1: o3.x1, y0: o3.y0, y1: o3.y1 })] });
});
P2.displayName = "Crosshair";
var N = (0, import_react6.createContext)({ showTooltipAt: function() {
}, showTooltipFromEvent: function() {
}, hideTooltip: function() {
} });
var V = { isVisible: false, position: [null, null], content: null, anchor: null };
var j = (0, import_react6.createContext)(V);
var O = function(t7) {
  var i3 = (0, import_react6.useState)(V), n3 = i3[0], l3 = i3[1], a4 = (0, import_react6.useCallback)(function(t8, i4, o3) {
    var n4 = i4[0], r4 = i4[1];
    void 0 === o3 && (o3 = "top"), l3({ isVisible: true, position: [n4, r4], anchor: o3, content: t8 });
  }, [l3]), c8 = (0, import_react6.useCallback)(function(i4, o3, n4) {
    void 0 === n4 && (n4 = "top");
    var r4 = t7.current.getBoundingClientRect(), e6 = t7.current.offsetWidth, a5 = e6 === r4.width ? 1 : e6 / r4.width, c9 = (o3.clientX - r4.left) * a5, h4 = (o3.clientY - r4.top) * a5;
    "left" !== n4 && "right" !== n4 || (n4 = c9 < r4.width / 2 ? "right" : "left"), l3({ isVisible: true, position: [c9, h4], anchor: n4, content: i4 });
  }, [t7, l3]), h3 = (0, import_react6.useCallback)(function() {
    l3(V);
  }, [l3]);
  return { actions: (0, import_react6.useMemo)(function() {
    return { showTooltipAt: a4, showTooltipFromEvent: c8, hideTooltip: h3 };
  }, [a4, c8, h3]), state: n3 };
};
var k2 = function() {
  var t7 = (0, import_react6.useContext)(N);
  if (void 0 === t7)
    throw new Error("useTooltip must be used within a TooltipProvider");
  return t7;
};
var z = function() {
  var t7 = (0, import_react6.useContext)(j);
  if (void 0 === t7)
...
var F = function() {
  var t7 = z();
  return A2(t7) ? (0, import_jsx_runtime2.jsx)(g, { position: t7.position, anchor: t7.anchor, children: t7.content }) : null;
};
var M = function(t7) {
  var i3 = t7.container, o3 = t7.children, n3 = O(i3), r4 = n3.actions, e6 = n3.state;
  return (0, import_jsx_runtime2.jsx)(N.Provider, { value: r4, children: (0, import_jsx_runtime2.jsx)(j.Provider, { value: e6, children: o3 }) });
};
...
function qe() {
  return qe = Object.assign || function(e6) {
    for (var r4 = 1; r4 < arguments.length; r4++) {
      var n3 = arguments[r4];
      for (var t7 in n3)
        Object.prototype.hasOwnProperty.call(n3, t7) && (e6[t7] = n3[t7]);
    }
    return e6;
...
function Se(e6, r4) {
  ...
  for (var n3 = 0, t7 = new Array(r4); n3 < r4; n3++)
    t7[n3] = e6[n3];
  return t7;
}
function Re(e6, r4) {
  ...
  if (Array.isArray(e6) || (n3 = function(e7, r5) {
    if (e7) {
      if ("string" == typeof e7)
        return Se(e7, r5);
      var n4 = Object.prototype.toString.call(e7).slice(8, -1);
      return "Object" === n4 && e7.constructor && (n4 = e7.constructor.name), "Map" === n4 || "Set" === n4 ? Array.from(e7) : "Arguments" === n4 || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n4) ? Se(e7, r5) : void 0;
    }
  }(e6)) || r4 && e6 && "number" == typeof e6.length) {
    n3 && (e6 = n3);
    var t7 = 0;
    return function() {
      return t7 >= e6.length ? { done: true } : { done: false, value: e6[t7++] };
    };
  }
...
var Qe2 = function(e6, r4) {
  ...
  if ((0, import_isPlainObject2.default)(e6)) {
    if (function(e7) {
      ...
      var n3 = (0, import_get2.default)(r4, e6.theme);
      if (void 0 === n3)
    ...
    if (function(e7) {
      ...
      var t7 = function(r5) {
        return (0, import_get2.default)(r5, e6.from);
      };
      if (Array.isArray(e6.modifiers)) {
        for (var o3, i3 = [], u3 = function() {
          var e7 = o3.value, r5 = e7[0], n4 = e7[1];
          if ("brighter" === r5)
            i3.push(function(e8) {
          ...
          u3();
        return 0 === i3.length ? t7 : function(e7) {
          return i3.reduce(function(e8, r5) {
            return r5(e8);
          }, rgb2(t7(e7))).toString();
        };
      }
...
var fr = function(e6, r4) {
  if ("function" == typeof e6)
    return e6;
  var n3 = "function" == typeof r4 ? r4 : function(e7) {
    return (0, import_get2.default)(e7, r4);
  };
  if (Array.isArray(e6)) {
    var t7 = ordinal(e6), o3 = function(e7) {
      return t7(n3(e7));
    };
    return o3.scale = t7, o3;
  }
  if ((0, import_isPlainObject2.default)(e6)) {
    if (function(e7) {
      ...
      return function(r5) {
        return (0, import_get2.default)(r5, e6.datum);
      };
    if (function(e7) {
      return void 0 !== e7.scheme;
    }(e6)) {
      if (Fe(e6.scheme)) {
        var i3 = ordinal($e[e6.scheme]), u3 = function(e7) {
          return i3(n3(e7));
        };
      ...
      if (He(e6.scheme)) {
        ...
        var a4 = ordinal($e[e6.scheme][e6.size || 11]), l3 = function(e7) {
          return a4(n3(e7));
        };
      ...
      if (Je(e6.scheme)) {
        ...
        var s4 = ordinal($e[e6.scheme][e6.size || 9]), c8 = function(e7) {
          return s4(n3(e7));
        };
        return c8.scale = s4, c8;
      }
    }
...
var m3 = function(e6) {
  var i3 = e6.x, n3 = e6.y, o3 = e6.size, r4 = e6.fill, l3 = e6.opacity, a4 = void 0 === l3 ? 1 : l3, c8 = e6.borderWidth, s4 = void 0 === c8 ? 0 : c8, d3 = e6.borderColor;
  return (0, import_jsx_runtime3.jsx)("circle", { r: o3 / 2, cx: i3 + o3 / 2, cy: n3 + o3 / 2, fill: r4, opacity: a4, strokeWidth: s4, stroke: void 0 === d3 ? "transparent" : d3, style: { pointerEvents: "none" } });
};
var f3 = function(e6) {
  var i3 = e6.x, n3 = e6.y, o3 = e6.size, r4 = e6.fill, l3 = e6.opacity, a4 = void 0 === l3 ? 1 : l3, c8 = e6.borderWidth, s4 = void 0 === c8 ? 0 : c8, d3 = e6.borderColor;
...
var u2 = function(e6) {
  var i3 = e6.x, n3 = e6.y, o3 = e6.size, r4 = e6.fill, l3 = e6.opacity, a4 = void 0 === l3 ? 1 : l3, c8 = e6.borderWidth, s4 = void 0 === c8 ? 0 : c8, d3 = e6.borderColor;
  return (0, import_jsx_runtime3.jsx)("rect", { x: i3, y: n3, fill: r4, opacity: a4, strokeWidth: s4, stroke: void 0 === d3 ? "transparent" : d3, width: o3, height: o3, style: { pointerEvents: "none" } });
};
var v3 = function(e6) {
  var i3 = e6.x, n3 = e6.y, o3 = e6.size, r4 = e6.fill, l3 = e6.opacity, a4 = void 0 === l3 ? 1 : l3, c8 = e6.borderWidth, s4 = void 0 === c8 ? 0 : c8, d3 = e6.borderColor;
  return (0, import_jsx_runtime3.jsx)("g", { transform: "translate(" + i3 + "," + n3 + ")", children: (0, import_jsx_runtime3.jsx)("path", { d: "\n                M" + o3 / 2 + " 0\n                L" + o3 + " " + o3 + "\n                L0 " + o3 + "\n                L" + o3 / 2 + " 0\n            ", fill: r4, opacity: a4, strokeWidth: s4, stroke: void 0 === d3 ? "transparent" : d3, style: { pointerEvents: "none" } }) });
...
function p2() {
  return p2 = Object.assign || function(t7) {
    for (var e6 = 1; e6 < arguments.length; e6++) {
      var i3 = arguments[e6];
      for (var n3 in i3)
        Object.prototype.hasOwnProperty.call(i3, n3) && (t7[n3] = i3[n3]);
    }
    return t7;
...
var k3 = function(t7) {
  var e6, i3 = t7.direction, n3 = t7.itemsSpacing, o3 = t7.padding, r4 = t7.itemCount, l3 = t7.itemWidth, a4 = t7.itemHeight;
  if ("number" != typeof o3 && ("object" != typeof (e6 = o3) || Array.isArray(e6) || null === e6))
    throw new Error("Invalid property padding, must be one of: number, object");
  var c8 = "number" == typeof o3 ? { top: o3, right: o3, bottom: o3, left: o3 } : p2({}, b3, o3), s4 = c8.left + c8.right, d3 = c8.top + c8.bottom, h3 = l3 + s4, g3 = a4 + d3, m4 = (r4 - 1) * n3;
  return "row" === i3 ? h3 = l3 * r4 + m4 + s4 : "column" === i3 && (g3 = a4 * r4 + m4 + d3), { width: h3, height: g3, padding: c8 };
};
var x4 = function(t7) {
  var e6 = t7.anchor, i3 = t7.translateX, n3 = t7.translateY, o3 = t7.containerWidth, r4 = t7.containerHeight, l3 = t7.width, a4 = t7.height, c8 = i3, s4 = n3;
  switch (e6) {
    case "top":
      c8 += (o3 - l3) / 2;
      break;
    ...
    case "left":
      ...
      break;
    case "center":
      c8 += (o3 - l3) / 2, s4 += (r4 - a4) / 2;
  }
  return { x: c8, y: s4 };
};
var S2 = function(t7) {
  var e6, i3, n3, o3, r4, l3, a4 = t7.direction, c8 = t7.justify, s4 = t7.symbolSize, d3 = t7.symbolSpacing, h3 = t7.width, g3 = t7.height;
  switch (a4) {
    case "left-to-right":
      e6 = 0, i3 = (g3 - s4) / 2, o3 = g3 / 2, l3 = "central", c8 ? (n3 = h3, r4 = "end") : (n3 = s4 + d3, r4 = "start");
      break;
    case "right-to-left":
      e6 = h3 - s4, i3 = (g3 - s4) / 2, o3 = g3 / 2, l3 = "central", c8 ? (n3 = 0, r4 = "start") : (n3 = h3 - s4 - d3, r4 = "end");
      break;
    case "top-to-bottom":
      e6 = (h3 - s4) / 2, i3 = 0, n3 = h3 / 2, r4 = "middle", c8 ? (o3 = g3, l3 = "alphabetic") : (o3 = s4 + d3, l3 = "text-before-edge");
      break;
    case "bottom-to-top":
      e6 = (h3 - s4) / 2, i3 = g3 - s4, n3 = h3 / 2, r4 = "middle", c8 ? (o3 = 0, l3 = "text-before-edge") : (o3 = g3 - s4 - d3, l3 = "alphabetic");
  }
  return { symbolX: e6, symbolY: i3, labelX: n3, labelY: o3, labelAnchor: r4, labelAlignment: l3 };
};
var O4 = { circle: m3, diamond: f3, square: u2, triangle: v3 };
var B2 = function(i3) {
  var n3, r4, l3, c8, h3, g3, m4, f4, u3, v4, y4, b4 = i3.x, k4 = i3.y, x5 = i3.width, A3 = i3.height, W2 = i3.data, z2 = i3.direction, C4 = void 0 === z2 ? "left-to-right" : z2, B3 = i3.justify, w3 = void 0 !== B3 && B3, X2 = i3.textColor, Y2 = i3.background, H2 = void 0 === Y2 ? "transparent" : Y2, E3 = i3.opacity, j2 = void 0 === E3 ? 1 : E3, T3 = i3.symbolShape, L = void 0 === T3 ? "square" : T3, M2 = i3.symbolSize, F2 = void 0 === M2 ? 16 : M2, P3 = i3.symbolSpacing, R = void 0 === P3 ? 8 : P3, q = i3.symbolBorderWidth, V2 = void 0 === q ? 0 : q, D2 = i3.symbolBorderColor, G = void 0 === D2 ? "transparent" : D2, I = i3.onClick, N2 = i3.onMouseEnter, _ = i3.onMouseLeave, J = i3.toggleSerie, K2 = i3.effects, Q = (0, import_react8.useState)({}), U = Q[0], Z = Q[1], $ = Vt(), tt2 = (0, import_react8.useCallback)(function(t7) {
    if (K2) {
      var e6 = K2.filter(function(t8) {
        return "hover" === t8.on;
      }).reduce(function(t8, e7) {
        return p2({}, t8, e7.style);
      }, {});
      Z(e6);
    }
    null == N2 || N2(W2, t7);
  }, [N2, W2, K2]), et2 = (0, import_react8.useCallback)(function(t7) {
    if (K2) {
      var e6 = K2.filter(function(t8) {
        return "hover" !== t8.on;
      }).reduce(function(t8, e7) {
    ...
    null == _ || _(W2, t7);
  }, [_, W2, K2]), it2 = S2({ direction: C4, justify: w3, symbolSize: null != (n3 = U.symbolSize) ? n3 : F2, symbolSpacing: R, width: x5, height: A3 }), nt2 = it2.symbolX, ot2 = it2.symbolY, rt2 = it2.labelX, lt = it2.labelY, at = it2.labelAnchor, ct = it2.labelAlignment, st2 = [I, N2, _, J].some(function(t7) {
    return void 0 !== t7;
  }), dt = "function" == typeof L ? L : O4[L];
  return (0, import_jsx_runtime3.jsxs)("g", { transform: "translate(" + b4 + "," + k4 + ")", style: { opacity: null != (r4 = U.itemOpacity) ? r4 : j2 }, children: [(0, import_jsx_runtime3.jsx)("rect", { width: x5, height: A3, fill: null != (l3 = U.itemBackground) ? l3 : H2, style: { cursor: st2 ? "pointer" : "auto" }, onClick: function(t7) {
    null == I || I(W2, t7), null == J || J(W2.id);
  }, onMouseEnter: tt2, onMouseLeave: et2 }), a3.createElement(dt, p2({ id: W2.id, x: nt2, y: ot2, size: null != (c8 = U.symbolSize) ? c8 : F2, fill: null != (h3 = null != (g3 = W2.fill) ? g3 : W2.color) ? h3 : "black", borderWidth: null != (m4 = U.symbolBorderWidth) ? m4 : V2, borderColor: null != (f4 = U.symbolBorderColor) ? f4 : G }, W2.hidden ? $.legends.hidden.symbol : void 0)), (0, import_jsx_runtime3.jsx)("text", { textAnchor: at, style: p2({}, $.legends.text, { fill: null != (u3 = null != (v4 = null != (y4 = U.itemTextColor) ? y4 : X2) ? v4 : $.legends.text.fill) ? u3 : "black", dominantBaseline: ct, pointerEvents: "none", userSelect: "none" }, W2.hidden ? $.legends.hidden.text : void 0), x: rt2, y: lt, children: W2.label })] });
};
var w2 = function(e6) {
  var i3 = e6.data, n3 = e6.x, o3 = e6.y, r4 = e6.direction, l3 = e6.padding, a4 = void 0 === l3 ? 0 : l3, c8 = e6.justify, s4 = e6.effects, d3 = e6.itemWidth, h3 = e6.itemHeight, g3 = e6.itemDirection, m4 = void 0 === g3 ? "left-to-right" : g3, f4 = e6.itemsSpacing, u3 = void 0 === f4 ? 0 : f4, v4 = e6.itemTextColor, p3 = e6.itemBackground, y4 = void 0 === p3 ? "transparent" : p3, b4 = e6.itemOpacity, x5 = void 0 === b4 ? 1 : b4, S3 = e6.symbolShape, A3 = e6.symbolSize, W2 = e6.symbolSpacing, z2 = e6.symbolBorderWidth, C4 = e6.symbolBorderColor, O5 = e6.onClick, w3 = e6.onMouseEnter, X2 = e6.onMouseLeave, Y2 = e6.toggleSerie, H2 = k3({ itemCount: i3.length, itemWidth: d3, itemHeight: h3, itemsSpacing: u3, direction: r4, padding: a4 }).padding, E3 = "row" === r4 ? d3 + u3 : 0, j2 = "column" === r4 ? h3 + u3 : 0;
  return (0, import_jsx_runtime3.jsx)("g", { transform: "translate(" + n3 + "," + o3 + ")", children: i3.map(function(e7, i4) {
    return (0, import_jsx_runtime3.jsx)(B2, { data: e7, x: i4 * E3 + H2.left, y: i4 * j2 + H2.top, width: d3, height: h3, direction: m4, justify: c8, effects: s4, textColor: v4, background: y4, opacity: x5, symbolShape: S3, symbolSize: A3, symbolSpacing: W2, symbolBorderWidth: z2, symbolBorderColor: C4, onClick: O5, onMouseEnter: w3, onMouseLeave: X2, toggleSerie: Y2 }, i4);
  }) });
};
var X = function(e6) {
  var i3 = e6.data, n3 = e6.containerWidth, o3 = e6.containerHeight, r4 = e6.translateX, l3 = void 0 === r4 ? 0 : r4, a4 = e6.translateY, c8 = void 0 === a4 ? 0 : a4, s4 = e6.anchor, d3 = e6.direction, h3 = e6.padding, g3 = void 0 === h3 ? 0 : h3, m4 = e6.justify, f4 = e6.itemsSpacing, u3 = void 0 === f4 ? 0 : f4, v4 = e6.itemWidth, p3 = e6.itemHeight, y4 = e6.itemDirection, b4 = e6.itemTextColor, S3 = e6.itemBackground, A3 = e6.itemOpacity, W2 = e6.symbolShape, z2 = e6.symbolSize, C4 = e6.symbolSpacing, O5 = e6.symbolBorderWidth, B3 = e6.symbolBorderColor, X2 = e6.onClick, Y2 = e6.onMouseEnter, H2 = e6.onMouseLeave, E3 = e6.toggleSerie, j2 = e6.effects, T3 = k3({ itemCount: i3.length, itemsSpacing: u3, itemWidth: v4, itemHeight: p3, direction: d3, padding: g3 }), L = T3.width, M2 = T3.height, F2 = x4({ anchor: s4, translateX: l3, translateY: c8, containerWidth: n3, containerHeight: o3, width: L, height: M2 }), P3 = F2.x, R = F2.y;
  return (0, import_jsx_runtime3.jsx)(w2, { data: i3, x: P3, y: R, direction: d3, padding: g3, justify: m4, effects: j2, itemsSpacing: u3, itemWidth: v4, itemHeight: p3, itemDirection: y4, itemTextColor: b4, itemBackground: S3, itemOpacity: A3, symbolShape: W2, symbolSize: z2, symbolSpacing: C4, symbolBorderWidth: O5, symbolBorderColor: B3, onClick: X2, onMouseEnter: Y2, onMouseLeave: H2, toggleSerie: "boolean" == typeof E3 ? void 0 : E3 });
};
var Y = { start: "left", middle: "center", end: "right" };
var H = function(t7, e6) {
  var i3 = e6.data, n3 = e6.containerWidth, o3 = e6.containerHeight, r4 = e6.translateX, l3 = void 0 === r4 ? 0 : r4, a4 = e6.translateY, c8 = void 0 === a4 ? 0 : a4, s4 = e6.anchor, d3 = e6.direction, h3 = e6.padding, g3 = void 0 === h3 ? 0 : h3, m4 = e6.justify, f4 = void 0 !== m4 && m4, u3 = e6.itemsSpacing, v4 = void 0 === u3 ? 0 : u3, p3 = e6.itemWidth, y4 = e6.itemHeight, b4 = e6.itemDirection, A3 = void 0 === b4 ? "left-to-right" : b4, W2 = e6.itemTextColor, z2 = e6.symbolSize, C4 = void 0 === z2 ? 16 : z2, O5 = e6.symbolSpacing, B3 = void 0 === O5 ? 8 : O5, w3 = e6.theme, X2 = k3({ itemCount: i3.length, itemWidth: p3, itemHeight: y4, itemsSpacing: v4, direction: d3, padding: g3 }), H2 = X2.width, E3 = X2.height, j2 = X2.padding, T3 = x4({ anchor: s4, translateX: l3, translateY: c8, containerWidth: n3, containerHeight: o3, width: H2, height: E3 }), L = T3.x, M2 = T3.y, F2 = "row" === d3 ? p3 + v4 : 0, P3 = "column" === d3 ? y4 + v4 : 0;
  t7.save(), t7.translate(L, M2), t7.font = w3.legends.text.fontSize + "px " + (w3.legends.text.fontFamily || "sans-serif"), i3.forEach(function(e7, i4) {
    var n4, o4, r5 = i4 * F2 + j2.left, l4 = i4 * P3 + j2.top, a5 = S2({ direction: A3, justify: f4, symbolSize: C4, symbolSpacing: B3, width: p3, height: y4 }), c9 = a5.symbolX, s5 = a5.symbolY, d4 = a5.labelX, h4 = a5.labelY, g4 = a5.labelAnchor, m5 = a5.labelAlignment;
    t7.fillStyle = null != (n4 = e7.color) ? n4 : "black", t7.fillRect(r5 + c9, l4 + s5, C4, C4), t7.textAlign = Y[g4], "central" === m5 && (t7.textBaseline = "middle"), t7.fillStyle = null != (o4 = null != W2 ? W2 : w3.legends.text.fill) ? o4 : "black", t7.fillText(String(e7.label), r5 + d4, l4 + h4);
  }), t7.restore();
};
...
//# sourceMappingURL=chunk-EXUUKMUT.js.map
