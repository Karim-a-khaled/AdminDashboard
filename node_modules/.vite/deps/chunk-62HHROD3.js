...
true ? MenuList.propTypes = {
   ...
   * @default false
   */
  autoFocusItem: import_prop_types9.default.bool,
  /**
...
var Popover = React11.forwardRef(function Popover2(inProps, ref) {
  ...
  return (0, import_jsx_runtime12.jsx)(RootSlot, _extends({}, rootProps, !isHostComponent(RootSlot) && {
    slotProps: rootSlotPropsProp
  }, {
    children: (0, import_jsx_runtime12.jsx)(TransitionComponent, _extends({
      ...
      children: (0, import_jsx_runtime12.jsx)(PaperSlot, _extends({}, paperProps, {
        children
      }))
    }))
  }));
...
var Menu = React12.forwardRef(function Menu2(inProps, ref) {
  ...
  return (0, import_jsx_runtime13.jsx)(MenuRoot, _extends({
    onClose,
    anchorOrigin: {
      vertical: "bottom",
    ...
    children: (0, import_jsx_runtime13.jsx)(MenuMenuList, _extends({
...
var NativeSelectInput = React13.forwardRef(function NativeSelectInput2(props, ref) {
  ...
  return (0, import_jsx_runtime15.jsxs)(React13.Fragment, {
    children: [(0, import_jsx_runtime14.jsx)(NativeSelectSelect, _extends({
      ownerState,
      className: clsx_default(classes.select, className),
      disabled,
      ref: inputRef || ref
    }, other)), props.multiple ? null : (0, import_jsx_runtime14.jsx)(NativeSelectIcon, {
      as: IconComponent,
      ownerState,
...
var SelectInput = React14.forwardRef(function SelectInput2(props, ref) {
  ...
  return (0, import_jsx_runtime17.jsxs)(React14.Fragment, {
    children: [(0, import_jsx_runtime16.jsx)(SelectSelect, _extends({
    ...
    })), (0, import_jsx_runtime16.jsx)(SelectNativeInput, _extends({
      "aria-invalid": error,
      ...
      autoFocus,
      ownerState
    }, other)), (0, import_jsx_runtime16.jsx)(SelectIcon, {
      as: IconComponent,
      className: classes.icon,
      ownerState
    }), (0, import_jsx_runtime16.jsx)(Menu_default, _extends({
      id: `menu-${name || ""}`,
...
true ? Select.propTypes = {
   ...
   * @default false
   */
  native: import_prop_types15.default.bool,
  /**
   * Callback fired when a menu item is selected.
   *
   ...
   */
  value: import_prop_types15.default.oneOfType([import_prop_types15.default.oneOf([""]), import_prop_types15.default.any]),
  /**
   * The variant to use.
   * @default 'outlined'
   */
...
var TextField = React17.forwardRef(function TextField2(inProps, ref) {
  ...
  const InputElement = (0, import_jsx_runtime20.jsx)(InputComponent, _extends({
  ...
  return (0, import_jsx_runtime21.jsxs)(TextFieldRoot, _extends({
    className: clsx_default(classes.root, className),
    disabled,
    error,
    fullWidth,
    ...
    children: [label != null && label !== "" && (0, import_jsx_runtime20.jsx)(InputLabel_default, _extends({
      ...
      children: label
    })), select ? (0, import_jsx_runtime20.jsx)(Select_default, _extends({
      "aria-describedby": helperTextId,
      id,
      ...
      children
    })) : InputElement, helperText && (0, import_jsx_runtime20.jsx)(FormHelperText_default, _extends({
      id: helperTextId
    }, FormHelperTextProps, {
      children: helperText
    }))]
...
true ? TextField.propTypes = {
   ...
   */
  FormHelperTextProps: import_prop_types16.default.object,
  /**
   * If `true`, the input will take up the full width of its container.
   * @default false
   */
   ...
   */
  helperText: import_prop_types16.default.node,
  /**
   * The id of the `input` element.
   ...
   */
  InputLabelProps: import_prop_types16.default.object,
  /**
   * [Attributes](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/input#Attributes) applied to the `input` element.
   */
   ...
   * @default false
   */
  select: import_prop_types16.default.bool,
  /**
...
//# sourceMappingURL=chunk-62HHROD3.js.map
